...
- `SKILL.md` should be **less than 250 lines** and include the references of related markdown files and scripts.
- Each script or referenced markdown file should be also **less than 250 lines**, remember that you can always split them into multiple files (**progressive disclosure** principle).
...
**File size:** Under 270 lines, if you need more, plit it to multiple files in `references` folder.
